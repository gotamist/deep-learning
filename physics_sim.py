...
class PhysicsSim():
    ...
    def next_timestep(self, rotor_speeds):
        ...
        angles = self.pose[3:] + self.angular_v * self.dt + 0.5 * self.angular_accels * self.dt**2 #there was a bug in the Udacity file. It should have 0.5omega*dt^2 and not 0.5omega^2*dt
